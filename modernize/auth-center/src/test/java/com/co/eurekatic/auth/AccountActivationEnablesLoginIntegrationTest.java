...
class AccountActivationEnablesLoginIntegrationTest {
    ...
    private void loginExpectingStatus(String username, String password, HttpStatus expected) {
    ...
    void loginBeforeActivationIsRejected() {
        ...
        // return 401, NOT 200.
        loginExpectingStatus("charlie", "newpass1", HttpStatus.UNAUTHORIZED);
    }
    ...
    void loginAfterActivationSucceedsAndIssuesJwt() throws Exception {
        ...
        byte[] body = webTestClient.post().uri("/login")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue("{\"username\":\"charlie\",\"password\":\"newpass1\"}")
                .exchange()
        ...
        assertThat(claims.get("sub").asText()).isEqualTo("charlie");
    }
    ...
    void loginAfterActivationButWithWrongPasswordIsRejected() {
        ...
        loginExpectingStatus("charlie", "wrong-pass", HttpStatus.UNAUTHORIZED);
    }
}
